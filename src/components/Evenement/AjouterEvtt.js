      ...
      <div className='AjouterEVNT'>
        <div className="ContainerEvnt">
          ...
          <div className="right-Evnt">
            <h1 className='formulaireEvnt'>Pour partager un évènement, cet espace est pour vous !</h1>
            <form onSubmit={handleSubmit}>
              <label className='LabelEvnt'>Titre:</label>
              <input type="text" className='InputEvnt' name="titre" placeholder="" required value={formData.titre} onChange={(e) => setFormData({ ...formData, titre: e.target.value })} />
              ...
              <input type="text" className='InputEvnt' name="lien" placeholder="" required value={formData.lien} onChange={(e) => setFormData({ ...formData, lien: e.target.value })} />
              <label className='LabelEvnt'>Lieu:</label>
              <input type="text" className='InputEvnt' name="lieu" placeholder="" required value={formData.lieu} onChange={(e) => setFormData({ ...formData, lieu: e.target.value })} />
              <label className='LabelEvnt'>Date:</label>
              <input type="text" className='InputEvnt' name="dates" placeholder="" required value={formData.dates} onChange={(e) => setFormData({ ...formData, dates: e.target.value })} />
